<template>
    <div class="py-5 px-7">
        ...
        >
            ...
            <div v-if="surveyFinished" class="py-8 px-6 bg-emerald-500 text-white w-[700px] mx-auto">
                <div class="text-xl mb-3 font-semibold">Thank you for your participation...</div>
                <button
                    type="button"
